...
class App extends PureComponent {
  ...
  RightBarEmail(){
    return <div className="emailLine">
            <div className="email"><span onClick={()=> this.addTab("Contact")}>contact@kevingillet.com</span></div>
           </div>
  }
  ...
  render () {
    ...
    <div id="app">
      ...
      <a href="https://github.com/Kev1venteur/PortfolioWebsite" target="_blank" id="footer" rel="noreferrer">Created and Designed by Kévin GILLET</a>
    </div>
    );
  }
}
